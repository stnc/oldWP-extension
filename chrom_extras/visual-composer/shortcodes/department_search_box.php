...
Class SearchProcess_Component
{
    ...
    public function DepartmanAndRelationCategoriesListAllHTML_for_chosen($list)
    {
...
function CHfw_serach($atts, $content = NULL)
{
    ...
    $background_color = (isset($atts['background_color'])) ? esc_attr($atts['background_color']) : 'transparent';
    ...
    $DepartmanAndRelationCategoriesListAllHTML = $search_field_component->DepartmanAndRelationCategoriesListAllHTML
    ($search_field_component->DepartmanAndRelationCategoriesListAll());
    ...
    $out = '
<section id="Find-Doctors-Page-Component" class="Find-Doctors-Page SearchComponent">
                ...
                <div class="row chfw-advanced-searchBorder">
                    <form action="/find-a-doctor/" method="get">
                        <div class="collabse">
                                 ...
                                 <div class="col-md-3 col-sm-6 col-xs-6 col-ms-12-">
                         
                                <h3 class="find_h1"><i class="fa fa-user-md" aria-hidden="true"></i>
                                    ' . $title . '
                                </h3>
                                   <div class="findinger">
                            ...
                            ';
    $out .= '<div class="col-md-3 col-sm-6 col-xs-6 col-ms-12-">
